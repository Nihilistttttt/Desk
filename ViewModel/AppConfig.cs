...
namespace GeekDesk.ViewModel
{
    ...
    public class AppConfig : INotifyPropertyChanged
    {
        ...
        private int cardOpacity = 40;  //默认0.1的不透明度  此处显示数值 * 100
        private int bgOpacity = 40; // 背景图片不透明度 此处显示数值 * 100
        private int pannelOpacity = 40; //主面板不透明度 此处显示数值 * 100
        ...
        private BGStyle bgStyle = BGStyle.GradientBac; //背景风格
        ...
        public int ImageWidth
        {
            ...
            set
            {
                ...
                //设置容器宽度
                ImgPanelWidth = (int)(ImageWidth * s * 0.6);
